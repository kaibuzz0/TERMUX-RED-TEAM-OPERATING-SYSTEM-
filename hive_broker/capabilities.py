...
BROKER_CAPABILITIES: tuple[Capability, ...] = (
    ...
    Capability("network.status", False, "none"),
    Capability("network.health", False, "none"),
    Capability("network.profile.read", False, "none"),
    Capability("diagnostics.health", False, "none"),
    Capability("diagnostics.doctor", False, "none"),
    Capability("diagnostics.audit", False, "none"),
    Capability("logs.status", False, "none"),
    Capability("logs.tail", False, "none"),
    Capability("logs.service.read", False, "none"),
    Capability("termux.integration.status", False, "none"),
